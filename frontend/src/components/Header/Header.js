    ...
    <header>
      ...
      <section className={`container ${styles["header-menu"]}`}>
        <div className={styles["header-menu__container"]}>
          <svg className={styles["header-menu__logo"]} enableBackground="new 0 0 289.167 200" version="1.1" width="120px" height="86.122px" viewBox="0 0 120 86.122" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
