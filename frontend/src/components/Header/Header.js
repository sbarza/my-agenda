    ...
    <header>
      <section className={styles["header-info"]}>
        <div className={`container ${styles["header-info__container"]}`}>
          <FontAwesomeIcon
            icon="phone"
            flip="horizontal"
            className={styles["header-info__icon--contact"]}
          />
          ...
          <a
            ...
            className={`${styles["header-info__data"]} ${styles["header-info__data--email"]}`}
          >
          ...
          >
            <FontAwesomeIcon
              icon={["fab", "facebook-f"]}
              className={styles["header-info__icon--social"]}
            />
          </a>
          <a
      ...
      <section className={`container ${styles["header-menu"]}`}>
        <div className={styles["header-menu__container"]}>
          <svg
            className={styles["header-menu__logo"]}
